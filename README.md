...
轻量本地工作区 Agent 与视觉小说翻译工作台，提供终端和 Web 界面。当前版本 **0.2.0**，项目原创代码与矢量图标采用 [MIT](LICENSE)。
...
| 版本 | 下载附件 | 使用方式 |
| --- | --- | --- |
| Windows 10/11 x64 便携版 | Nagi-0.2.0-windows-x64.zip | 完整解压后双击 Start Nagi.vbs，自带独立 Python、MCP、Frida |
| 源码版 | Nagi-0.2.0-source.zip / 源码仓库 | 自行安装 Python 3.12+ 后初始化环境 |
| Python 安装包 | nagi-0.2.0-py3-none-any.whl | 安装到自己的 Python 环境，网页和运行模板随包提供 |
